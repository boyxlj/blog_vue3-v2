...
router.beforeEach( (to,from,next)=>{
    ...
    console.log(from.path,to.path,to.path.includes("/details"))
    if((from.path.includes("/search") && to.path.includes("/tags"))|| ((from.path.includes("/search") && to.path.includes("/details")))){
