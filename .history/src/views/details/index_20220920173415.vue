...
import {getArtContentById, getRandomArt, getSubmitCollect, getUpdatePageView,setCollectNum,setCommentNum} from "@/api/request";
...
const updates = (type:any, value:any,commentCount:any) => {
  ...
  if (type == "comment") {
    if (value == "jia") {
      ...
      setComment(detailData.artPcomment * 1 - commentCount < 0 ? 0 : artPcomment.value * 1 - commentCount)
    }
  }
}
</script>
